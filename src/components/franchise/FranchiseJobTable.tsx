...
export interface FranchiseJobTableProps {
  jobs: FranchiseJob[]
...
const FranchiseJobTable: React.FC<FranchiseJobTableProps> = ({
  jobs, onMarkComplete, onCancel, className
}) => {
            ...
            {jobs.length === 0 ? (
              ...
              jobs.map(job => (
                <tr key={job.id}>
                  ...
                  <td className="px-3 py-2">{job.assignedTo}</td>
...
export default FranchiseJobTable
