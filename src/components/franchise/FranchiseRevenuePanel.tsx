...
export interface FranchiseRevenuePanelProps {
  totalRevenue: number
...
const FranchiseRevenuePanel: React.FC<FranchiseRevenuePanelProps> = ({
...
export default FranchiseRevenuePanel
