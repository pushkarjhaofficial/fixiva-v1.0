...
export interface CorpContractViewProps {
  contracts: CorpContract[]
  onDownload?: (id: string) => void
  className?: string
}
const CorpContractView: React.FC<CorpContractViewProps> = ({
            ...
            {contracts.length === 0 ? (
              ...
              contracts.map(c => (
                <tr key={c.id}>
                  ...
                  <td className="px-3 py-2">{c.partner}</td>
...
export default CorpContractView
