...
export function ModifyThisBooking({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("ModifyThisBooking", {
            defaultValue: "ModifyThisBooking",
          })}
        ...
        >
          ...
          {t("ModifyThisBooking", { defaultValue: "ModifyThisBooking" })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default ModifyThisBooking;
