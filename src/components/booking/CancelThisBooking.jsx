...
export function CancelThisBooking({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("CancelThisBooking", {
            defaultValue: "CancelThisBooking",
          })}
        ...
        >
          ...
          {t("CancelThisBooking", { defaultValue: "CancelThisBooking" })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default CancelThisBooking;
