...
export function YourBookingSummary({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("YourBookingSummary", {
            defaultValue: "YourBookingSummary",
          })}
...
export default YourBookingSummary;
