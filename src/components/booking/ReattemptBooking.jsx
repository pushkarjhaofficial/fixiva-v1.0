...
export function ReattemptBooking({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("ReattemptBooking", {
            defaultValue: "ReattemptBooking",
          })}
        ...
        >
          ...
          {t("ReattemptBooking", { defaultValue: "ReattemptBooking" })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default ReattemptBooking;
