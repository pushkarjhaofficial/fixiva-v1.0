...
export function YourBookingIsConfirmed({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("YourBookingIsConfirmed", {
            defaultValue: "YourBookingIsConfirmed",
          })}
...
export default YourBookingIsConfirmed;
