...
export function ManuallyAssignABooking({ onClick, disabled = false }) {
    ...
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          onClick={handleClick}
          disabled={disabled}
          aria-label={t("ManuallyAssignABooking", {
            defaultValue: "ManuallyAssignABooking",
          })}
        ...
        >
          ...
          {t("ManuallyAssignABooking", { defaultValue: "ManuallyAssignABooking" })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default ManuallyAssignABooking;
