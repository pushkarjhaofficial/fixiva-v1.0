...
export function VendorCalendarAvailability({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('VendorCalendarAvailability', { defaultValue: 'VendorCalendarAvailability' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('VendorCalendarAvailability', { defaultValue: 'VendorCalendarAvailability' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default VendorCalendarAvailability;
