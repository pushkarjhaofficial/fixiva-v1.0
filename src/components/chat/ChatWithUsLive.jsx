...
export function ChatWithUsLive({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('ChatWithUsLive', { defaultValue: 'ChatWithUsLive' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('ChatWithUsLive', { defaultValue: 'ChatWithUsLive' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
