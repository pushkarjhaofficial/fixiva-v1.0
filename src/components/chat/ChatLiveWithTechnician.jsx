...
export function ChatLiveWithTechnician({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('ChatLiveWithTechnician', { defaultValue: 'ChatLiveWithTechnician' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('ChatLiveWithTechnician', { defaultValue: 'ChatLiveWithTechnician' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default ChatLiveWithTechnician;
