...
export function FloatingAIChat({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('FloatingAIChat', { defaultValue: 'FloatingAIChat' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('FloatingAIChat', { defaultValue: 'FloatingAIChat' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
