...
export function AIChatAssistantWidget({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('AIChatAssistantWidget', { defaultValue: 'AIChatAssistantWidget' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('AIChatAssistantWidget', { defaultValue: 'AIChatAssistantWidget' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default AIChatAssistantWidget;
