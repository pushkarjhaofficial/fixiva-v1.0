...
export function CloseChatSession({ onClick, disabled = false }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <button
          aria-label={t('CloseChatSession', { defaultValue: 'CloseChatSession' })}
          onClick={handleClick}
          disabled={disabled}
        ...
        >
          ...
          {t('CloseChatSession', { defaultValue: 'CloseChatSession' })}
        </button>
      </Tooltip.Trigger>
    </Tooltip.Root>
  );
...
export default CloseChatSession;
